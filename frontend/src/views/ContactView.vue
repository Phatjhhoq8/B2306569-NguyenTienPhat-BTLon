<template>
  <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12 font-sans">
    ...
    <!-- Google Map Section (Full Width in Middle) -->
    <div class="w-full h-96 rounded-3xl border border-slate-200 shadow-md overflow-hidden">
      <iframe 
        :src="contactSettings.mapUrl || 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3928.847525380536!2d105.76632497464796!3d10.029452072517865!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31a0895a535749f7%3A0xe54d37537b020a1c!2zVGjGsCB2aeG7h24gVHJ1bmcgdMOibSDEkOG6oWkgaOG7jWMgQ-G6p24gVGjGoQ!5e0!3m2!1svi!2s!4v1711200000000!5m2!1svi!2s'" 
        width="100%" 
        height="100%" 
        style="border:0;" 
        allowfullscreen="" 
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
      <!-- Left Column: Primary Contact (Gray Box) -->
      <div class="bg-slate-100 rounded-3xl p-8 space-y-4 shadow-sm hover:shadow-md transition-shadow">
        <h2 class="font-sans text-xl md:text-2xl font-extrabold text-slate-900">
          {{ contactSettings.libraryName || 'Thư viện Trung tâm ĐH Cần Thơ' }}
        </h2>
        <div class="space-y-3 text-sm text-slate-600 leading-relaxed">
          <p><strong>Địa chỉ:</strong> {{ contactSettings.address || 'Khu II, Đường 3/2, Phường Xuân Khánh, Quận Ninh Kiều, TP. Cần Thơ' }}</p>
          <p><strong>Hotline:</strong> <a :href="'tel:' + (contactSettings.hotline || '02923832663').replace(/\s+/g, '')" class="text-primary font-bold hover:underline">{{ contactSettings.hotline || '0292 3832 663' }}</a></p>
          <p><strong>Email:</strong> <a :href="'mailto:' + (contactSettings.email || 'support@ctu.edu.vn')" class="text-primary font-bold hover:underline">{{ contactSettings.email || 'support@ctu.edu.vn' }}</a></p>
        </div>
      </div>

      <!-- Right Column: More Info (Blue Box) -->
      <div class="bg-primary text-white rounded-3xl p-8 space-y-4 shadow-sm hover:shadow-md transition-shadow">
...
onMounted(async () => {
  try {
    ...
    if (res.success && res.data && Object.keys(res.data).length > 0) {
      contactSettings.value = { ...contactSettings.value, ...res.data };
    }
  } catch (err) {
